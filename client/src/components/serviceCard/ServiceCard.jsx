        ...
        <div  className="col">
            <div className={style.card} 
                ...
                <div style={{ background: ` rgba(0, 0, 0, 0.5)` }}className="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                    <h3 className="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">{service}   <br />
                    <button className={style.shoppingcart}><img className={style.shopping} src={shopping} alt="shoppingCart" /></button>
                    </h3>
